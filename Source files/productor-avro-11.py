...
def job_send_data(api_response):
    ...
    name_object = ccloud_lib_11.Name()
    name_object.name = 'telemtry'
    record_key = name_object.to_dict()
    print(record_key)
    record_value = dict(temperature=api_response['current']['temperature'],
...
if __name__ == '__main__':
    ...
    # Initialization
    args = ccloud_lib_11.parse_args()
    config_file = args.config_file
    topic = args.topic
    conf = ccloud_lib_11.read_ccloud_config(config_file)
    ...
    }, default_key_schema=ccloud_lib_11.schema_key, default_value_schema=ccloud_lib_11.schema_value)

    # Create topic if needed
    ccloud_lib_11.create_topic(conf, topic)

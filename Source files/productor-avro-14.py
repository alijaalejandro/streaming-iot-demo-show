...
def job_send_data(api_response):
    ...
    name_object = ccloud_lib_14.Name()
...
if __name__ == '__main__':
    ...
    # Initialization
    args = ccloud_lib_14.parse_args()
    config_file = args.config_file
    topic = args.topic
    conf = ccloud_lib_14.read_ccloud_config(config_file)
    ...
    }, default_key_schema=ccloud_lib_14.schema_key, default_value_schema=ccloud_lib_14.schema_value)

    # Create topic if needed
    ccloud_lib_14.create_topic(conf, topic)
